    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Intakeballpile1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(44.028, 32.314), new Pose(9.694, 32.718))
                    )
            ...
            Grabballpile2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(43.624, 57.560), new Pose(9.088, 56.954))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Pickupballpile3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(44.028, 81.189), new Pose(15.349, 80.987))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
